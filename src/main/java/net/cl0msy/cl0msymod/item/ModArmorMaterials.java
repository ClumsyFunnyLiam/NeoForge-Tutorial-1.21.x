...
public class ModArmorMaterials {
    public static final Holder<ArmorMaterial> WOAR_ARMOR_MATERIAL = register("woar", Util.make(new EnumMap<>(ArmorItem.Type.class), attribute -> {
    ...
    }), 20, 0.5f, 0.5f, () -> ModItems.WOAR.get());
    ...
    private static Holder<ArmorMaterial> register(String name, EnumMap<ArmorItem.Type, Integer> typeProtection, int enchantability, float toughness, float knockbackResistance, Supplier<Item> ingredientItem) {
        ...
        ResourceLocation location = ResourceLocation.fromNamespaceAndPath(Cl0msyMod.MODID, name);
